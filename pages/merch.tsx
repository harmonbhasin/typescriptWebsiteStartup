...
import Layout from '../components/layout/merchLayout'
 ...
 * and the newsletter.
 */
const Merch: NextPageWithLayout = () => (
  <Box
    bg={Handsome.lightAccent}
    // css={{
    //   backgroundImage: CONFETTI,
    //   backgroundAttachment: 'fixed',
    // }}
  >
    <Box p={10} color={Handsome.lightShade}>
      <SimpleProduct />
    </Box>
    <Box p={10} height={{ md: '200px' }} bg={Handsome.lightAccent} />
  </Box>
)

Merch.getLayout = (page: ReactElement) => {
